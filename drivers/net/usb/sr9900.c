 ...
 */
#define SR9900_MAC_FILE "/data/SR9900_MAC_ADDR"
#endif

#define	DRIVER_VERSION	"v1." NETNEXT_VERSION "." NET_VERSION
#define	DRIVER_AUTHOR	"Corechips linux nic maintainers"
#define	DRIVER_DESC	"Corechip SR9900 Based USB 2.0 Ethernet Adapters"
#define	MODULENAME	"sr9900"

#define R8152_PHY_ID		32

#define	VENDOR_ID_CORECHIPS	0x0fe6
...
#define	LED_CL	0xc000
#define	LED_OP	0x0000
...
static int rtl8152_open(struct net_device *netdev)
{
	...
	/* light the led when open the interface */
	ocp_write_word(tp, MCU_TYPE_PLA, PLA_CRWECR, LED_OP);
#ifdef CONFIG_PM_SLEEP
...
static int rtl8152_close(struct net_device *netdev)
{
	...
	/* close the led when if-down the interface */
	ocp_write_word(tp, MCU_TYPE_PLA, PLA_CRWECR, LED_CL);
#ifdef CONFIG_PM_SLEEP
...
static const struct usb_device_id rtl8152_table[] = {
	{USB_DEVICE(VENDOR_ID_CORECHIPS, PRODUCT_ID_SR9900)},
	/* Realtek */
